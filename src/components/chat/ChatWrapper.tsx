...
import { ChevronLeft, Loader2, TrendingUp, XCircle } from 'lucide-react';
...
const ChatWrapper = ({ fileId }: ChatWrapperProps) => {
	...
	if (isLoading)
		return (
			<div className='relative min-h-full bg-zinc-50 flex divide -y divide-zinc-200 pt-6 flex-col justify-between gap-2'>
